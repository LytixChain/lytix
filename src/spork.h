...
#define SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT 1543871903 //ON
#define SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT_DEFAULT 1543871903  //ON
#define SPORK_10_MASTERNODE_PAY_UPDATED_NODES_DEFAULT 1543871903  //OFF
