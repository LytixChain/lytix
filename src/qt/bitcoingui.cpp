...

{
    ...
    QString windowTitle = tr("Lytix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lytix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lytix: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLYTX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lytix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lytix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lytix"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lytix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lytix addresses"));
    ...
    openAction->setStatusTip(tr("Open a Lytix: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lytix Core help message to get a list with possible Lytix command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lytix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lytix network", "", count));
}
...
{
    QString strTitle = tr("Lytix Core"); // default title
