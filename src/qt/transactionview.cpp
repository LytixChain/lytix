 ...
 */
    ...
    typeWidget->addItem(tr("Maxnode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MAXReward));
    typeWidget->addItem(tr("Dev Fee"), TransactionFilterProxy::TYPE(TransactionRecord::DEVReward));
