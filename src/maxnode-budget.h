...
public:
    ...
    std::map<uint256, CBudgetProposalBroadcast> mapSeenMaxnodeBudgetProposals;
    std::map<uint256, CBudgetVote> mapSeenMaxnodeBudgetVotes;
    std::map<uint256, CBudgetVote> mapOrphanMaxnodeBudgetVotes;
