...
This mechanism has been integrated into Bitcore-Node-Lytix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Lytix-Project/insight-api-lytix#web-socket-api](https://github.com/Lytix-Project/insight-api-lytix#web-socket-api) 
* API: [https://github.com/Lytix-Project/insight-api-lytix#swifttx-transactions](https://github.com/Lytix-Project/insight-api-lytix#swifttx-transactions) 
...
By default, the Lytix Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lytix Core daemon:
