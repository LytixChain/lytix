...
In order to support loading of multiple wallets in lytix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lytix.cpp.
...
Changes to lytix.cpp
----------------------
lytix.cpp is the entry point into lytix-qt, and as such, will require some minor modifications to provide hooks for
